...
boolean DellPSU::read_data(){
    ...
    if (data[0]=='D' & data[1]=='E' & data[2]=='L' & data[3]=='L'& data[4]=='0'& data[5]=='0'& data[6]=='A'& data[7]=='C')
    { 
      ...
      _watts = 100*(uint16_t)(data[8]-48) + 10*(uint16_t)(data[9]-48) + (data[10]-48);
      _millivolts = 10000*(uint16_t)(data[11]-48) + 1000*(uint16_t)(data[12]-48) + 100*(uint16_t)(data[13]-48);
      _milliamps = 10000*(uint16_t)(data[14]-48) + 1000*(uint16_t)(data[15]-48) + 100*(uint16_t)(data[16]-48);
      return true;
    }
    else
    {
